...
function Projects() {
  return (
    <div
      id="project"
      className="project bg-black mt-[100px] md:mt-0 flex pb-20 flex-col xl:pt-[100px] h-auto justify-center items-center gap-5 w-[90%] mx-auto "
    >
      <motion.div
      ...
      <div className="grid gap-4  3xl:grid-cols-5  w-full lg:pt-10 grid-cols-1 xl:gap-7 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 3xl:grid-cols-5">
        {
